...
struct qt_meta_stringdata_UiComboLine_t {
    QByteArrayData data[4];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_UiComboLine_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UiComboLine_t qt_meta_stringdata_UiComboLine = {
    {
QT_MOC_LITERAL(0, 0, 11), // "UiComboLine"
QT_MOC_LITERAL(1, 12, 12), // "itemSelected"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 4) // "text"

    },
    "UiComboLine\0itemSelected\0\0text"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_UiComboLine[] = {
...
void UiComboLine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UiComboLine::itemSelected)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject UiComboLine::staticMetaObject = { {
    QMetaObject::SuperData::link<QLineEdit::staticMetaObject>(),
    qt_meta_stringdata_UiComboLine.data,
    qt_meta_data_UiComboLine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *UiComboLine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UiComboLine.stringdata0))
